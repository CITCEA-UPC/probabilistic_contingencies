...
[insolvable,Vslack_min,sigma,eta,mineigratio] = insolvablepf(res,mpopt);
t_ok(insolvable, [t ' insolvable']);
t_is(Vslack_min, Vslack_min_soln, 3, [t ' Vslack_min']);
t_is(sigma, sigma_soln, 3, [t ' sigma']);
t_is(eta, eta_soln, 3, [t ' eta']);
