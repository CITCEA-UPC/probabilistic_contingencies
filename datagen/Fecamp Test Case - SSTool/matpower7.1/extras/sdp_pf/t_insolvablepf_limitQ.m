...
t0 = 'INSOLVABLEPF_LIMITQ : ';

%% test an insolvable case
load soln9mod_opf;     %% defines bus_soln, gen_soln, branch_soln, eta_limitQinsolvable_soln
...
[insolvable,eta,mineigratio] = insolvablepf_limitQ(res,mpopt);
t_ok(insolvable, [t ' insolvable']);
t_is(eta, eta_limitQinsolvable_soln, 3, [t ' eta']);


%% test a solvable case
load soln9mod_opf;     %% defines bus_soln, gen_soln, branch_soln, eta_limitQsolvable_soln
...
t_is(eta, eta_limitQsolvable_soln , 3, [t ' eta']);
