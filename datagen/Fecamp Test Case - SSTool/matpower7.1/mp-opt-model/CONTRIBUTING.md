MP-Opt-Model Contributors Guide
===============================
...
[MP-Opt-Model][1] and [MATPOWER][2] are community efforts and your
...
helps to communicate your respect for the time and efforts of the
MP-Opt-Model developer community managing and developing this open source
project.
...
This repository, for the MP-Opt-Model distribution, is organized in the
following directories:
- `docs` - User's Manual
- `lib` - software that implements MP-Opt-Model's core functions
...
Your participation is welcomed on the two mailing lists for MATPOWER and
MP-Opt-Model users and developers, [MATPOWER-L][5] and
[MATPOWER-DEV-L][6], respectively. We can always use help in answering
...
The [MP-Opt-Model issue tracker][7] is the preferred channel for
reporting bugs or submitting code changes (pull requests). A good bug
report is extremely helpful and benefits the entire community, so if you
find a bug, including a mistake in the documentation, please report it.
...
Check out your copy locally and configure the remotes:
  ...
  git clone https://github.com/<your-username>/mp-opt-model.git
  # go to the newly cloned directory
  cd mp-opt-model
  # assign the original repo to a remote called "upstream"
  git remote add upstream https://github.com/MATPOWER/mp-opt-model.git
  ```
...
look something like:
  ...
  Fixes: https://github.com/MATPOWER/mp-opt-model/issues/4
  Refs: https://www.mail-archive.com/matpower-l@cornell.edu/msg05557.html
  Refs: https://github.com/MATPOWER/mp-opt-model/pull/5
  ```
...
be added to `test_mp_opt_model.m`. See the documentation for [MP-Test][3]
and the existing MP-Opt-Model test files (e.g.
[`t_opt_model`](lib/t/t_opt_model.m)) for examples of how to write tests.

You can run your tests by typing the name of your test function at the
MATLAB or Octave prompt, or `test_mp_opt_model` to run the entire test suite.
...
for your fork (`https://github.com/<your-username>/mp-opt-model`), and selecting
...
Collaborator, it can be merged into the upstream MP-Opt-Model repository. Once
...
the MP-Opt-Model project and community for helping to make it a useful tool for
the optimization community. **Thank you!**
...
[7]: https://github.com/MATPOWER/mp-opt-model/issues
...
[16]: LICENSE
[17]: https://scottchacon.com/2011/08/31/github-flow.html
