    ...
    switch OPTION2
        ...
        case 'MAGREAL'
            ...
            ylabel('Magnitude','FontName', 'Times New Roman','FontAngle','normal','FontWeight','bold','FontSize',14)
            ...
            xlabel('frequency [Hz]','FontName', 'Times New Roman','FontAngle','normal','FontWeight','bold','FontSize',14)
            ylabel('Real part','FontName', 'Times New Roman','FontAngle','normal','FontWeight','bold','FontSize',14)
        ...
        case 'MAGPH'
            ...
            set(gca,'XGrid','on','FontName','Times New Roman','FontSize',12,'Position',pos22);
            xlabel('frequency [Hz]','FontName', 'Times New Roman','FontAngle','normal','FontWeight','bold','FontSize',14)
            ylabel('Phase [degrees]','FontName', 'Times New Roman','FontAngle','normal','FontWeight','bold','FontSize',14)
        ...
        case 'BODE'
            ...
            ylabel('Magnitude [dB]','FontName', 'Times New Roman','FontAngle','normal','FontWeight','bold','FontSize',14)
            %legend(legendname,'FontName','Times New Roman','FontSize',12);
        ...
        case 'IMAG'
            ...
            set(gca,'XGrid','on','FontName','Times New Roman','FontSize',12);
            xlabel('frequency [Hz]','FontName', 'Times New Roman','FontAngle','normal','FontWeight','bold','FontSize',14)
            ylabel('Imaginary part','FontName', 'Times New Roman','FontAngle','normal','FontWeight','bold','FontSize',14)
            plot([FINF,FSUP],[0,0],'--','LineWidth',1,'Color',[0.7 0.7 0.7])
            %legend(legendname,'FontName','Times New Roman','FontSize',12);
        ...
        case 'PASS'
            ...
            set(gca,'XScale','log','xticklabel',{[]},'XGrid','on','FontName','Times New Roman','FontSize',12,'Position',pos21);
            ylabel('$\lambda_{min}$','FontName', 'Times New Roman','FontAngle','normal','FontWeight','bold','FontSize',14)
            plot([FINF,FSUP],[0,0],'--','LineWidth',1,'Color',[0.7 0.7 0.7])
            ...
            set(gca,'XScale','log','XGrid','on','FontName','Times New Roman','FontSize',12,'Position',pos22);
            xlabel('frequency [Hz]','FontName', 'Times New Roman','FontAngle','normal','FontWeight','bold','FontSize',14)
            ylabel('$\lambda_{min}$ flag','FontName', 'Times New Roman','FontAngle','normal','FontWeight','bold','FontSize',14)
            %legend(legendname,'FontName','Times New Roman','FontSize',12);
            set(gca,'YTick',[0 1],'YTickLabel',[0 1]);
        case 'NYQ'
            
            subplot(NSUB,1,NSUB);
            set(gca,'XScale','linear','FontName','Times New Roman','FontSize',14,'Position',pos1);
            xlabel('Real axis','FontName', 'Times New Roman','FontAngle','normal','FontWeight','bold','FontSize',14)
            ylabel('Imaginary axis','FontName', 'Times New Roman','FontAngle','normal','FontWeight','bold','FontSize',14) 
            hold on
            axis equal
            %grid on
            ...
            plot(-1,0,'+','MarkerSize',15,'LineWidth',2,'Color',[0 0 0]);
