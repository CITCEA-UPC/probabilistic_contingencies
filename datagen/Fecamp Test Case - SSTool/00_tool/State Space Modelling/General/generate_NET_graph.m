function  generate_NET_graph(connect_mtx, T_trafo, T_DC_NET, T_NET, T_nodes, T_load, T_TH, T_SG, T_VSC, T_user)
    ...
    if any(Madj,'all')
        ...
        ax2=plot(NaN,NaN,'Color',color_rl); %plotting invisible points of desired colors
        ax3=plot(NaN,NaN,'Color',color_tf); %plotting invisible points of desired colors
        [~, hobj, ~, ~] = legend([ax1,ax2,ax3],'PI-line','RL-line','Trafo','Location','best','FontSize',8); %adding the legend     
